...
class Main(object):
    ...
    def pretrain_generator(self):
        ...
        for step in range(cfg.g_pretrain):
            faked_images, _ = self.fake_images_loader.__iter__().next()
    ...
    def pretrain_discrimintor(self):
        ...
        print('pre-training the discriminator network %d times...' % cfg.g_pretrain)
        self.D.train()
        self.G.eval()
    ...
    def train(self):
        ...
        for step in range(self.current_step, cfg.train_steps):
            ...
            print('(Refiner) loss:%.4f reg_loss:%.4f, adv_loss:%.4f' % (r_loss.data[0], reg_loss.data[0], adv_loss.data[0]))
